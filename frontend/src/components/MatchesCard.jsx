...
const MatchesCard = ({ matchName, date, likedUserId }) => {
    ...
    return (
        <div className="flex flex-row items-center w-1/4 mb-2">
            <img src={image} alt="Match profile" className="h-20 w-20 object-cover rounded-full mr-4" />
            <div className="flex flex-col items-start w-full border-b border-gray-300 py-4">
                <div className="flex flex-row justify-between items-center w-full">
                    ...
                    <span className="font-medium text-sm text-right">{formattedDate}</span>
                </div> 
                <p className="text-sm max-w-md text-left pt-2 text-gray-600">
